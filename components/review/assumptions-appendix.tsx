...
export function AssumptionsAppendix({ appendix }: { appendix: AssumptionsAppendix }) {
  ...
  return <section className="rounded-3xl border border-[#e8dcc6] bg-[#fffaf0] p-8">
    ...
    <p className="mt-2 max-w-3xl text-[#627085]">Key entered assumptions shown against planning references. Benchmarks are planning references and should be validated against the customer’s operating data.</p>
