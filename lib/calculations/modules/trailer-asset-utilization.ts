...
export function calculateTrailerAssetUtilization(inputs: TrailerAssetUtilizationInputs) {
 return validOrIssues("TRAILER_ASSET_UTILIZATION", inputs, [...positive(inputs.trailer_count,"trailer_count"),...positive(inputs.tractor_count,"tractor_count"),...positive(inputs.ratio_improvement_pct,"ratio_improvement_pct"),...positive(inputs.asset_life_months,"asset_life_months")], () => {
