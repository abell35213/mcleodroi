...
export type CoverSlideModel = { companyName: string; analysisDate?: string; preparedBy?: string; coverLogoPath?: string | null; titleSlideImagePath?: string | null; customerLogoDataUri?: string | null; slideNumber?: number };
