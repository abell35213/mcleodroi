...
export type CoverSlideModel = { companyName: string; analysisDate?: string; preparedBy?: string; coverLogoPath?: string | null; titleSlideImagePath?: string | null; slideNumber?: number };
